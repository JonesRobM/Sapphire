"""One-off Au/Pt extended-xyz writer. Was pasted into Utilities/ExtendXYZ.py as a second
`Extend` class, shadowing the real one. Moved here 2026-08-28. Not importable as-is."""
