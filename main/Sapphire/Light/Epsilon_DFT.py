...
class Ni(object):
    ...
    def __init__(self, interpolate_order=1):
        ...
        self.wl = 1000*np.array([
                                0.017586, 0.017712, 0.017839, 0.017969, 0.0181, 0.018233,
                                ...
                                0.708481, 0.826561, 0.991874, 1.23984, 1.65312, 2.47968,
                                ])

        self.n_real = np.array([
                                0.884, 0.9017, 0.9139, 0.8945, 0.8809, 0.8702,
                                0.8619, 0.8532, 0.8444, 0.8365, 0.8296, 0.8299,
                                0.8398, 0.8127, 0.9924, 1.2183, 1.0754, 1.0261,
                                1.0022, 0.9897, 0.983, 0.9786, 0.9693, 0.9571,
                                0.9464, 0.9404, 0.9365, 0.9341, 0.9322, 0.9309,
                                0.9259, 0.9207, 0.9166, 0.9131, 0.9114, 0.9115,
                                0.9102, 0.9018, 0.8941, 0.8911, 0.8913, 0.8919,
                                0.8929, 0.8942, 0.8953, 0.892, 0.8904, 0.8871,
                                0.8846, 0.8819, 0.8771, 0.873, 0.8711, 0.8699,
                                0.8657, 0.8609, 0.8562, 0.8515, 0.8476, 0.8411,
                                0.8339, 0.8284, 0.8242, 0.8211, 0.8173, 0.8146,
                                0.813, 0.8129, 0.8153, 0.8199, 0.8223, 0.8201,
                                0.8239, 0.8192, 0.8051, 0.7926, 0.7893, 0.7948,
                                0.802, 0.8077, 0.7918, 0.7543, 0.7081, 0.6686,
                                0.6674, 0.6765, 0.6897, 0.7191, 0.7654, 0.8134,
                                0.8692, 0.9153, 0.9513, 0.9554, 0.9586, 0.9459,
                                0.9242, 0.9004, 0.8749, 0.8532, 0.8378, 0.8321,
                                0.8399, 0.8583, 0.8737, 0.887, 0.9011, 0.9213,
                                0.9504, 0.9891, 1.0421, 1.0925, 1.1111, 1.1403,
                                1.1283, 1.0765, 1.0645, 1.0635, 1.032, 0.9803,
                                0.9956, 1.087, 1.0458, 1.0736, 1.1251, 1.1499,
                                1.1273, 1.0002, 0.9778, 1.1887, 1.8849, 1.9972,
                                1.5795, 1.2474, 1.1685, 1.1632, 1.2019, 1.2801,
                                1.3985, 1.5675, 1.6111, 1.6956, 1.892, 2.3897,
                                2.526, 2.6303, 2.7829, 3.1325, 3.1188, 3.0684,
                                ])

        self.n_imag = np.array([
                                0.116, 0.1225, 0.1012, 0.085, 0.0891, 0.096,
                                0.1044, 0.1137, 0.1267, 0.1441, 0.1681, 0.1994,
                                0.2352, 0.2541, 0.6338, 0.1354, 0.0916, 0.0887,
                                0.0913, 0.0925, 0.0916, 0.0879, 0.0805, 0.0778,
                                0.0819, 0.0856, 0.0892, 0.0926, 0.0944, 0.0924,
                                0.0913, 0.0934, 0.096, 0.0986, 0.1031, 0.1042,
                                0.1022, 0.1009, 0.1068, 0.1139, 0.12, 0.1245,
                                0.1277, 0.1292, 0.129, 0.1289, 0.1297, 0.1302,
                                0.1323, 0.1332, 0.1351, 0.1386, 0.1441, 0.1437,
                                0.1461, 0.1487, 0.1518, 0.155, 0.1593, 0.1629,
                                0.1685, 0.1768, 0.185, 0.193, 0.2025, 0.2111,
                                0.2214, 0.2319, 0.2422, 0.2476, 0.2493, 0.2561,
                                0.2567, 0.2533, 0.2571, 0.2687, 0.2882, 0.2995,
                                0.3117, 0.2972, 0.281, 0.2738, 0.3008, 0.3522,
                                0.4128, 0.4612, 0.5154, 0.5632, 0.6023, 0.6233,
                                0.6281, 0.6146, 0.5839, 0.5485, 0.5357, 0.5106,
                                0.5021, 0.5037, 0.5172, 0.5421, 0.5753, 0.6159,
                                0.6584, 0.6926, 0.7193, 0.7435, 0.7752, 0.8092,
                                0.8428, 0.8731, 0.8933, 0.8732, 0.8622, 0.8445,
                                0.7875, 0.8086, 0.8469, 0.8684, 0.8798, 0.9466,
                                1.0682, 1.1035, 1.1255, 1.2262, 1.2719, 1.3188,
                                1.3107, 1.4627, 1.7488, 2.1485, 2.163, 1.583,
                                1.3732, 1.6426, 1.9286, 2.1879, 2.4408, 2.692,
                                2.9424, 3.1356, 3.3295, 3.6809, 4.1311, 4.4457,
